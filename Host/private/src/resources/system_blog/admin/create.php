...
<head>
    ...
    <title>Novo Post - Sistema de Blog</title>
    ...
    <div class="container mt-4">
        <div class="row">
            ...
            <div class="col-md-8">
                <!-- Title Input -->
                <div class="mb-3">
                    <input type="text" class="form-control form-control-lg" placeholder="Título do Post">
                </div>
                ...
                <div class="editor-content" contenteditable="true">
                    Digite o conteúdo do seu post aqui...
                </div>
            </div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="url-do-post">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Descrição</label>
                            <textarea class="form-control" rows="3" placeholder="Breve descrição do post..."></textarea>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Separe as tags por vírgula">
                        </div>
                    </div>
                </div>
